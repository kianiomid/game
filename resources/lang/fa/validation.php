...
return [
    ...
    */
    ...
    'unique' => 'مقدار فیلد :attribute قبلا استفاده شده است.',
    'uploaded'             => 'بارگذاری فایل :attribute موفقیت آمیز نبود.',
    'url'                  => ':attribute معتبر نمی‌باشد.',
    'uuid'                 => ':attribute باید یک UUID معتبر باشد.',
    'clean_descriptor' => 'مقدار :attribute تنها می تواند شامل کاراکتر های حروفی و عددی، - و _ باشد.',
    'clean_name' => 'مقدار :attribute غیرمجاز است.',
    ...
    */
    ...
    'custom' => [
        'emails.*' => [
            'email' => 'آدرس ایمیل :input معتبر نیست.',
        ],
        'reserved_data' => 'مقدار فیلد :attribute رزرو می باشد. لطفا مقدار دیگری انتخاب نمایید.',
        'unique_two' => 'موردی تکراری با مقادیر فیلد های :attribute1 و :attribute2 وجود دارد.',
        'one_holder_for_organization' => 'برای هر واحد سازمانی تنها یک سرپرست فعال می تواند ثبت گردد.'
    ],
